...
It is OK to talk to others in class about what you are doing. It is even OK to explain to someone how some particular things works (e.g., how pthread_create() works). However, it is NOT OK to share code outside your team. If your team is having trouble, come talk to me instead. 
...
Hints
Ie recommend understanding how the code that we gave you works. All of the code is available as a zip file on Canvas. I provide the following files: 
